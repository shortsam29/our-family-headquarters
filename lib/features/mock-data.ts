...
export const secondaryDestinations: SecondaryDestination[] = [
  ...
  { slug: "grocery", title: "Grocery List", eyebrow: "Food and household groceries", description: "Food, drinks, produce, frozen, pantry, and household groceries in their own list.", group: "Plan & provide", ownership: "Grocery items remain separate from general household shopping.", highlights: [], emptyMessage: "No groceries are waiting." },
